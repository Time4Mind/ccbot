...
Полный список — в `doc/dm-multisession-spec.md` § 12.
...
Свежая live-card подгружает до `CARD_SEED_TURNS` (по умолчанию 20)
последних end-of-turn-границ из JSONL-транскрипта сессии, чтобы
история не пропадала после рестарта бота.
