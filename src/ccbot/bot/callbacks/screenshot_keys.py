...
The screenshot inline keyboard sends quick keystrokes to the active pane
and re-renders the screenshot afterwards.
"""
...
from ...handlers.callback_data import CB_KEYS_PREFIX, CB_SCREENSHOT_REFRESH
from ...screenshot import text_to_image
from ...tmux_manager import tmux_manager
from ..commands.info import build_screenshot_keyboard
