...
Live-card implementation is split across focused ``card_*`` modules; the
historical ``notifications`` and ``card_model`` paths are compatibility
facades. See ``doc/refactor-architecture.md`` for the extension map.
"""
