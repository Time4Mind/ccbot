...
RU: dict[str, str] = {
    ...
    "settings.group.spoiler_block_lines": "Строк в команде/результате",
    "settings.spoiler_lines.body": (
        "*Строки команды и результата*\n\n"
        "Максимум видимых строк в каждом блоке спойлера. Команда и результат "
        "получают выбранный лимит независимо; одна строка ограничена 70 символами."
    ),
    "screens.on": "on",
    "screens.off": "off",
