...
ZH: dict[str, str] = {
    ...
    "dir.btn.up": "..",
    "dir.btn.select": "选择",
    "dir.btn.create": "新建文件夹",
    "dir.create.prompt": "{path}\n\n请输入一个不含斜杠的新文件夹名称。",
    "dir.create.created": "文件夹已创建。",
    "dir.create.exists": "文件夹已存在 - 正在打开。",
    "dir.create.failed": "无法创建文件夹。",
    "picker.title": "*恢复会话?*",
    ...
    "archive.age.h": "{n}时",
    "archive.age.d": "{n}天",
    "archive.column.session": "会话",
    "archive.column.description": "描述",
    "archive.link.yql": "YQL 链接",
    "archive.link.tracker": "Tracker 链接",
    "archive.link.github": "GitHub 链接",
    "archive.link.arcanum": "Arcanum 链接",
    "archive.link.wiki": "Wiki 链接",
    "archive.link.generic": "链接: {host}",
    "usage.title": "*Claude Code*",
    "usage.title.codex": "*OpenAI Codex*",
    "usage.status_age": "状态 · {age}分",
    "usage.column.cli": "CLI",
    "usage.column.5h": "5小时",
    "usage.column.week": "本周",
    "usage.column.today": "今天",
    "usage.column.reset": "重置",
    ...
    "settings.group.option_button_transfer": "会话转移",
    "settings.option_button_transfer.body": (
        "*会话转移*\n\n显示将上下文转移到其他节点的按钮。"
        "仅在有多个节点且会话空闲时显示。"
    ),
    "nodes.title": "*节点*",
    "nodes.empty": "没有已注册的节点。",
    "nodes.table.node": "节点",
    "nodes.table.state": "状态",
    "nodes.table.backends": "后端",
    "nodes.state.pending": "连接中",
    ...
    "settings.preprocessing_mode.body": "*预处理模式*\n\n关闭、仅语音或所有文本和语音请求。",
    "settings.preprocessing_instruction.body": "*预处理指令*\n\n空值使用内置的保守指令。",
    "preprocessing.mode.off": "关闭",
    "preprocessing.mode.voice": "仅语音",
    "preprocessing.mode.all": "所有请求",
    "preprocessing.instruction.builtin": "内置",
    "preprocessing.instruction.custom": "自定义",
    "preprocessing.instruction.edit": "修改",
    "preprocessing.instruction.reset": "恢复内置",
    "preprocessing.instruction.send": "请用一条文本消息发送新指令。",
    "preprocessing.instruction.invalid": "指令不能为空且不能超过 16 KiB。",
